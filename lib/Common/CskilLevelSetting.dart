...
class CskilLevelSetting{
  ...
  CskilLevelSetting({required this.OPPONENT_ID,required this.SERVE_1ST,required this.SERVE_2ND,required this.STROKE_BACKHAND,required this.STROKE_FOREHAND,required this.VOLLEY_BACKHAND,required this.VOLLEY_FOREHAND});
}