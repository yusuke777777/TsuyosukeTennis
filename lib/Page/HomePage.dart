...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<String>>? futureList = FirestoreMethod.getNickNameAndTorokuRank(uid);
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                          ...
                          Text('名前：'+profileList![0], style: TextStyle(fontSize: 30)), // This trailing comma makes auto-formatting nicer for build methods.
                          SizedBox(
                            width:10,
                          ),
                          ClipOval(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center, children:  <Widget>[
                          ...
                          Text('登録ランク：'+profileList[1], style: TextStyle(fontSize: 30)), // This trailing comma makes auto-formatting nicer for build methods.
                        ]
                        ),
                        //シングルスランキング表示
