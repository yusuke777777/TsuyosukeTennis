...
class _ProfileSettingState extends State<ProfileSetting> {
                      ...
                      child: TextButton(
                        ...
                        onPressed: () async {
                          ...
                          if (nickName.text.isNotEmpty &&
                            ...
                            else if (inputUserID.text.length < 5 || inputUserID
                                .text.length > 20) {
                              showDialog(
                                  context: context,
                                  builder: (context) {
  ...
  void _showModalLocationPicker(BuildContext context, int No,
      TextEditingController shichoson) {
    curTourokuNo = No;
