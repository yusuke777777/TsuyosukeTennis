  ...
  Future<void> createRankList() async {
    ...
    try {
      ...
      final futures = querySnapshot.docs.map((doc) async {
        ...
        final yourProfileFuture = FirestoreMethod.getYourProfile(userId);
        final yourProfileDetailFuture =
            FirestoreMethod.getYourDetailProfile(userId);
        final yourProfile = await yourProfileFuture;
        final yourProfileDetail = await yourProfileDetailFuture;
      ...
      final rankList = await Future.wait(futures);
